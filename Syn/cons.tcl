...
create_generated_clock -master_clock $uart_clk -source [get_ports UART_CLK] -name UART_RX_CLK [get_port CLK_DIV_RX/o_div_clk] -divide_by 1
...
create_generated_clock -master_clock $uart_clk -source [get_ports UART_CLK] -name UART_TX_CLK [get_port CLK_DIV_TX/o_div_clk] -divide_by 32
...
create_generated_clock -master_clock $ref_clk  -source [get_ports REF_CLK]  -name ALU_CLK [get_port Clock_gating_SYS_TOP/GATED_CLK] -divide_by 1
...
set out_uart_rx_delay [expr 0.2 * $UART_CLK_PER]
set out_uart_tx_delay [expr $out_uart_rx_delay * 32]

#Constrain Input Paths
set_input_delay  $in_uart_delay -clock UART_CLK [get_port UART_RX_IN]

#Constrain Output Paths
set_output_delay $out_uart_tx_delay -clock UART_TX_CLK [get_port UART_TX_O]
set_output_delay $out_uart_rx_delay -clock UART_RX_CLK [get_port parity_error]
set_output_delay $out_uart_rx_delay -clock UART_RX_CLK [get_port framing_error]
