...
# Created by write_sdc on Thu Oct 9 21:44:09 2025
...
create_clock [get_ports UART_CLK]  -period 271.27  -waveform {0 135.635}
...
create_generated_clock [get_pins CLK_DIV_RX/o_div_clk]  -name UART_RX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 1  -add
set_clock_uncertainty -setup 0.2  [get_clocks UART_RX_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks UART_RX_CLK]
create_generated_clock [get_pins CLK_DIV_TX/o_div_clk]  -name UART_TX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 32  -add
set_clock_uncertainty -setup 0.2  [get_clocks UART_TX_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks UART_TX_CLK]
create_generated_clock [get_pins Clock_gating_SYS_TOP/GATED_CLK]  -name ALU_CLK  -source [get_ports REF_CLK]  -master_clock REF_CLK  -divide_by 1  -add
...
set_input_delay -clock UART_CLK  54.254  [get_ports UART_RX_IN]
set_output_delay -clock UART_TX_CLK  1736.13  [get_ports UART_TX_O]
set_output_delay -clock UART_RX_CLK  54.254  [get_ports parity_error]
set_output_delay -clock UART_RX_CLK  54.254  [get_ports framing_error]
